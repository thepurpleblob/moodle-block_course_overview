...
$string['nocourses'] = 'There are no courses in you favourites. <br>Go in the courses tab and click on the star icon <i class="icon fa fa-fw fa-star-o " title="Make favourite"></i> to select your favourite courses.';
$string['none'] = 'None';
